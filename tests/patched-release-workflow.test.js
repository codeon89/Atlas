...
describe('nightly-patched release workflow', () => {
  ...
  // Installer names contain spaces (`Atlas-Setup 0.9.9-...exe`): matching
  // against space-split names can never hit, so names stay newline-joined and
  // match whole-line. A regression here publishes nothing, ever.
